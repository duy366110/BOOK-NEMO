    ...
    renderInvoice = async (req, res, next) => {
        try {
            ...
            if(orderInfor) {
                ...
                // let file = [{
                //     url: path.join(__dirname, "../", "document", "invoice.html"),
                //     name: 'invoice.pdf',
                //     path: path.join(__dirname, "../", "document")
                // }];
                
                // htmlToPdf.generatePdfs(file, options).then(pdfBuffer => {
                //     console.log("PDF Buffer:-", pdfBuffer);

                //     // console.log(Buffer.concat(pdfBuffer));
                //     // let doc = fs.createReadStream(Buffer.concat(pdfBuffer));
